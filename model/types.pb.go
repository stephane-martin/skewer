...
type FullMessage struct {
	...
	ConnId     github_com_stephane_martin_skewer_utils.MyULID `protobuf:"bytes,6,opt,name=conn_id,json=connId,proto3,customtype=github.com/stephane-martin/skewer/utils.MyULID" json:"conn_id"`
	ConfId     github_com_stephane_martin_skewer_utils.MyULID `protobuf:"bytes,7,opt,name=conf_id,json=confId,proto3,customtype=github.com/stephane-martin/skewer/utils.MyULID" json:"conf_id"`
...
func (this *FullMessage) Equal(that interface{}) bool {
	...
	if this.ClientAddr != that1.ClientAddr {
		return false
	}
...
func (this *FullMessage) GoString() string {
	...
	s = append(s, "SourcePath: "+fmt.Sprintf("%#v", this.SourcePath)+",\n")
...
func (m *FullMessage) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ClientAddr) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintTypes(dAtA, i, uint64(len(m.ClientAddr)))
		i += copy(dAtA[i:], m.ClientAddr)
	}
	if len(m.SourceType) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintTypes(dAtA, i, uint64(len(m.SourceType)))
	...
	if m.SourcePort != 0 {
		dAtA[i] = 0x28
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.SourcePort))
	}
	dAtA[i] = 0x32
	i++
	i = encodeVarintTypes(dAtA, i, uint64(m.ConnId.Size()))
	n3, err := m.ConnId.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n3
...
func (m *FullMessage) Size() (n int) {
	...
	if m.SourcePort != 0 {
		n += 1 + sovTypes(uint64(m.SourcePort))
	}
	l = m.ConnId.Size()
	n += 1 + l + sovTypes(uint64(l))
	l = m.ConfId.Size()
...
func (this *FullMessage) String() string {
	...
	s := strings.Join([]string{`&FullMessage{`,
		...
		`ClientAddr:` + fmt.Sprintf("%v", this.ClientAddr) + `,`,
...
var fileDescriptorTypes = []byte{
	...
	,
}
