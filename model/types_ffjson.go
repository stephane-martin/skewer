...
const (
	ffjtSyslogMessagebase = iota
	ffjtSyslogMessagenosuchkey

	ffjtSyslogMessagePriority

	ffjtSyslogMessageFacility

	ffjtSyslogMessageSeverity

	ffjtSyslogMessageVersion

	ffjtSyslogMessageTimeReported

	ffjtSyslogMessageTimeGenerated

	ffjtSyslogMessageHostname

	ffjtSyslogMessageAppname

	ffjtSyslogMessageProcid

	ffjtSyslogMessageMsgid

	ffjtSyslogMessageStructured

	ffjtSyslogMessageMessage

	ffjtSyslogMessageAuditSubMessages

	ffjtSyslogMessageProperties
)

var ffjKeySyslogMessagePriority = []byte("priority")

var ffjKeySyslogMessageFacility = []byte("facility")

var ffjKeySyslogMessageSeverity = []byte("severity")

var ffjKeySyslogMessageVersion = []byte("version")

var ffjKeySyslogMessageTimeReported = []byte("timereported")

var ffjKeySyslogMessageTimeGenerated = []byte("timegenerated")

var ffjKeySyslogMessageHostname = []byte("hostname")

var ffjKeySyslogMessageAppname = []byte("appname")

var ffjKeySyslogMessageProcid = []byte("procid")

var ffjKeySyslogMessageMsgid = []byte("msgid")

var ffjKeySyslogMessageStructured = []byte("structured")

var ffjKeySyslogMessageMessage = []byte("message")

var ffjKeySyslogMessageAuditSubMessages = []byte("audit")

var ffjKeySyslogMessageProperties = []byte("properties")

// UnmarshalJSON umarshall json - template of ffjson
func (j *SyslogMessage) UnmarshalJSON(input []byte) error {
	fs := fflib.NewFFLexer(input)
	return j.UnmarshalJSONFFLexer(fs, fflib.FFParse_map_start)
}

// UnmarshalJSONFFLexer fast json unmarshall - template ffjson
func (j *SyslogMessage) UnmarshalJSONFFLexer(fs *fflib.FFLexer, state fflib.FFParseState) error {
	var err error
	currentKey := ffjtSyslogMessagebase
	_ = currentKey
	tok := fflib.FFTok_init
	wantedTok := fflib.FFTok_init
...
mainparse:
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				// "" case. hrm.
				currentKey = ffjtSyslogMessagenosuchkey
				state = fflib.FFParse_want_colon
				goto mainparse
			} else {
				switch kn[0] {
				...
				case 'a':
					...
					if bytes.Equal(ffjKeySyslogMessageAppname, kn) {
						currentKey = ffjtSyslogMessageAppname
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffjKeySyslogMessageAuditSubMessages, kn) {
						currentKey = ffjtSyslogMessageAuditSubMessages
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'f':
					...
					if bytes.Equal(ffjKeySyslogMessageFacility, kn) {
						currentKey = ffjtSyslogMessageFacility
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'h':
					...
					if bytes.Equal(ffjKeySyslogMessageHostname, kn) {
						currentKey = ffjtSyslogMessageHostname
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'm':
					...
					if bytes.Equal(ffjKeySyslogMessageMsgid, kn) {
						currentKey = ffjtSyslogMessageMsgid
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffjKeySyslogMessageMessage, kn) {
						currentKey = ffjtSyslogMessageMessage
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'p':
					...
					if bytes.Equal(ffjKeySyslogMessagePriority, kn) {
						currentKey = ffjtSyslogMessagePriority
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffjKeySyslogMessageProcid, kn) {
						currentKey = ffjtSyslogMessageProcid
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffjKeySyslogMessageProperties, kn) {
						currentKey = ffjtSyslogMessageProperties
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 's':
					...
					if bytes.Equal(ffjKeySyslogMessageSeverity, kn) {
						currentKey = ffjtSyslogMessageSeverity
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffjKeySyslogMessageStructured, kn) {
						currentKey = ffjtSyslogMessageStructured
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 't':
					...
					if bytes.Equal(ffjKeySyslogMessageTimeReported, kn) {
						currentKey = ffjtSyslogMessageTimeReported
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffjKeySyslogMessageTimeGenerated, kn) {
						currentKey = ffjtSyslogMessageTimeGenerated
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'v':
					...
					if bytes.Equal(ffjKeySyslogMessageVersion, kn) {
						currentKey = ffjtSyslogMessageVersion
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffjKeySyslogMessageProperties, kn) {
					currentKey = ffjtSyslogMessageProperties
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffjKeySyslogMessageAuditSubMessages, kn) {
					currentKey = ffjtSyslogMessageAuditSubMessages
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeySyslogMessageMessage, kn) {
					currentKey = ffjtSyslogMessageMessage
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeySyslogMessageStructured, kn) {
					currentKey = ffjtSyslogMessageStructured
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeySyslogMessageMsgid, kn) {
					currentKey = ffjtSyslogMessageMsgid
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffjKeySyslogMessageProcid, kn) {
					currentKey = ffjtSyslogMessageProcid
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffjKeySyslogMessageAppname, kn) {
					currentKey = ffjtSyslogMessageAppname
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeySyslogMessageHostname, kn) {
					currentKey = ffjtSyslogMessageHostname
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffjKeySyslogMessageTimeGenerated, kn) {
					currentKey = ffjtSyslogMessageTimeGenerated
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffjKeySyslogMessageTimeReported, kn) {
					currentKey = ffjtSyslogMessageTimeReported
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeySyslogMessageVersion, kn) {
					currentKey = ffjtSyslogMessageVersion
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeySyslogMessageSeverity, kn) {
					currentKey = ffjtSyslogMessageSeverity
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffjKeySyslogMessageFacility, kn) {
					currentKey = ffjtSyslogMessageFacility
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffjKeySyslogMessagePriority, kn) {
					currentKey = ffjtSyslogMessagePriority
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtSyslogMessagePriority:
					goto handle_Priority

				case ffjtSyslogMessageFacility:
					goto handle_Facility

				case ffjtSyslogMessageSeverity:
					goto handle_Severity

				case ffjtSyslogMessageVersion:
					goto handle_Version

				case ffjtSyslogMessageTimeReported:
					goto handle_TimeReported

				case ffjtSyslogMessageTimeGenerated:
					goto handle_TimeGenerated

				case ffjtSyslogMessageHostname:
					goto handle_Hostname

				case ffjtSyslogMessageAppname:
					goto handle_Appname

				case ffjtSyslogMessageProcid:
					goto handle_Procid

				case ffjtSyslogMessageMsgid:
					goto handle_Msgid

				case ffjtSyslogMessageStructured:
					goto handle_Structured

				case ffjtSyslogMessageMessage:
					goto handle_Message

				case ffjtSyslogMessageAuditSubMessages:
					goto handle_AuditSubMessages

				case ffjtSyslogMessageProperties:
					goto handle_Properties

				case ffjtSyslogMessagenosuchkey:
					err = fs.SkipField(tok)
					if err != nil {
						return fs.WrapErr(err)
					}
...
handle_Priority:
	...
	/* handler: j.Priority type=model.Priority kind=int quoted=true*/
...
handle_Facility:
	...
	/* handler: j.Facility type=model.Facility kind=int quoted=true*/
...
handle_Severity:
	...
	/* handler: j.Severity type=model.Severity kind=int quoted=true*/
...
handle_Version:
	...
	/* handler: j.Version type=model.Version kind=int quoted=true*/
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				j.AuditSubMessages = append(j.AuditSubMessages, tmpJAuditSubMessages)
