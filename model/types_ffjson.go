...
func (j *ErrInvalid5424) MarshalJSON() ([]byte, error) {
...
func (j *ErrInvalid5424) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	if j == nil {
		buf.WriteString("null")
		return nil
	}
	...
	fflib.WriteJsonString(buf, string(j.Property))
	buf.WriteString(`,"Value":`)
	/* Interface types must use runtime reflection. type=interface {} kind=interface */
	err = buf.Encode(j.Value)
	if err != nil {
		return err
	}
	buf.WriteByte('}')
...
const (
	ffjtErrInvalid5424base = iota
	ffjtErrInvalid5424nosuchkey

	ffjtErrInvalid5424Property

	ffjtErrInvalid5424Value
)

var ffjKeyErrInvalid5424Property = []byte("Property")

var ffjKeyErrInvalid5424Value = []byte("Value")

// UnmarshalJSON umarshall json - template of ffjson
func (j *ErrInvalid5424) UnmarshalJSON(input []byte) error {
	fs := fflib.NewFFLexer(input)
	return j.UnmarshalJSONFFLexer(fs, fflib.FFParse_map_start)
}

// UnmarshalJSONFFLexer fast json unmarshall - template ffjson
func (j *ErrInvalid5424) UnmarshalJSONFFLexer(fs *fflib.FFLexer, state fflib.FFParseState) error {
	var err error
	currentKey := ffjtErrInvalid5424base
	_ = currentKey
...
mainparse:
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				// "" case. hrm.
				currentKey = ffjtErrInvalid5424nosuchkey
				...
				case 'P':
					...
					if bytes.Equal(ffjKeyErrInvalid5424Property, kn) {
						currentKey = ffjtErrInvalid5424Property
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'V':
					...
					if bytes.Equal(ffjKeyErrInvalid5424Value, kn) {
						currentKey = ffjtErrInvalid5424Value
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.SimpleLetterEqualFold(ffjKeyErrInvalid5424Value, kn) {
					currentKey = ffjtErrInvalid5424Value
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffjKeyErrInvalid5424Property, kn) {
					currentKey = ffjtErrInvalid5424Property
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtErrInvalid5424Property:
					goto handle_Property

				case ffjtErrInvalid5424Value:
					goto handle_Value

				case ffjtErrInvalid5424nosuchkey:
...
handle_Property:
	...
	/* handler: j.Property type=string kind=string quoted=false*/

	{
		...
		if tok == fflib.FFTok_null {
			...
			j.Property = string(string(outBuf))
...
handle_Value:
	...
	/* handler: j.Value type=interface {} kind=interface quoted=false*/

	{
		...
		err = json.Unmarshal(tbuf, &j.Value)
		if err != nil {
			return fs.WrapErr(err)
		}
	}
